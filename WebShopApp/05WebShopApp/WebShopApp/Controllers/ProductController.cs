...
namespace WebShopApp.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [AllowAnonymous]
        public ActionResult Index(string searchCategoryName, string searchBrandName)
        {
            List<ProductIndexVM> products =_productService.GetProducts(searchCategoryName,searchBrandName)
        ...
        {
            var deleted = _productService.RemoveBy(id);
            if (deleted)
            {
